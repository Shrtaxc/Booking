...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><strong> Easy Book</strong> By Deniz</a></li>
			...
			<div class="center">
				<h1>Vir-Host</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Online Booking System</p><br>
